 ...
 * Use the [ConnectivityStatusFragment.newInstance] factory method to
...
class ConnectivityStatusFragment : Fragment() {
    ...
    companion object {
         ...
         * @return A new instance of fragment ConnectivityStatusFragment.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
                ConnectivityStatusFragment().apply {
